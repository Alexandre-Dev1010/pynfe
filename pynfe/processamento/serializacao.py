...
class SerializacaoXML(Serializacao):
    ...
    def _serializar_autorizados_baixar_xml(
        ...
        if len(so_numeros(autorizados_baixar_xml)) == 11:
            etree.SubElement(raiz, "CPF").text = so_numeros(autorizados_baixar_xml)
        else:
            etree.SubElement(raiz, "CNPJ").text = so_numeros(autorizados_baixar_xml)
    ...
    def _serializar_produto_servico(
        ...
        if produto_servico.totais_tributos_aproximado:
            etree.SubElement(imposto, "vTotTrib").text = str(produto_servico.totais_tributos_aproximado)
    ...
    def _serializar_imposto_pis(
        ...
        if produto_servico.pis_situacao_tributaria in pisnt:
            ...
            etree.SubElement(pis_item, "CST").text = produto_servico.pis_situacao_tributaria
        elif produto_servico.pis_situacao_tributaria == "01" or produto_servico.pis_situacao_tributaria == "02":
    ...
    def _serializar_imposto_cofins(
        ...
        if produto_servico.cofins_situacao_tributaria in cofinsnt:
            ...
            etree.SubElement(cofins_item, "CST").text = produto_servico.cofins_situacao_tributaria
        elif produto_servico.cofins_situacao_tributaria == "01" or produto_servico.cofins_situacao_tributaria == "02":
    ...
    def _serializar_nota_fiscal(self, nota_fiscal, tag_raiz="infNFe", retorna_string=True):
        ...
        raiz.append(self._serializar_autorizados_baixar_xml(nota_fiscal.autorizados_baixar_xml, retorna_string=False))
        ...
        if (nota_fiscal.fatura_numero) or (
            ...
            if nota_fiscal.duplicatas and len(nota_fiscal.duplicatas) > 0:
                for num, item in enumerate(nota_fiscal.duplicatas):
                    ...
                    etree.SubElement(dup, "nDup").text = f"00{item.numero}"
